...
### Key tasks
**1. Data cleaning**  
Removed duplicates, standardized missing values, and interpolated missing life expectancy values  

**2. Exploratory data analysis**  
Analyzed GDP/BMI correlations & explored mortality trends

---

### Findings
* Higher GDP is generally associated with higher life expectancy
* Higher BMI countries also tended to show higher life expectancy
* Developed countries showed consistently higher averages
